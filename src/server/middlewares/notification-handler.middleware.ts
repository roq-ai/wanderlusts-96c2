...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'travel_plan.create': {
    roles: ['travel-planner', 'administrator'],
    key: 'new-travel-plan',
    tenantPath: ['organization', 'user', 'travel_plan'],
    userPath: [],
  },
  'travel_plan.update': {
    roles: ['travel-planner', 'administrator'],
    key: 'travel-plan-update',
    tenantPath: ['organization', 'user', 'travel_plan'],
    userPath: [],
  },
  'destination.update': {
    roles: ['travel-planner', 'administrator', 'content-creator'],
    key: 'destination-update',
    tenantPath: ['organization', 'destination'],
    userPath: [],
  },
};

const ownerRoles: string[] = ['travel-planner'];
const customerRoles: string[] = ['guest'];
const tenantRoles: string[] = ['administrator', 'content-creator', 'travel-planner', 'web-designer'];
