...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['travel-planner', 'administrator', 'content-creator', 'web-designer'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Widgets', path: '/widgets', entity: 'widget', service: AccessServiceEnum.PROJECT, icon: FiSliders },
