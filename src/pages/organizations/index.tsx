...
export function OrganizationListPage(props: OrganizationListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getOrganizations({
        relations: ['user', 'destination.count', 'widget.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('destination', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          ...
          cell: ({ row: { original: record } }: any) => record?._count?.destination,
        }
      : null,
    hasAccess('widget', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'widget',
          header: 'Widget',
          accessorKey: 'widget',
          cell: ({ row: { original: record } }: any) => record?._count?.widget,
        }
      : null,
