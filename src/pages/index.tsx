...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Wanderlusts`}</title>

        <meta
          name="description"
          content="Discover your next adventure with Wanderlusts - Your personalized travel plan application for Wordpress. Optimize your journey from start to finish, tailored to your preferences."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1682685796444-acc2f5c1b7b6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MXwxfHNlYXJjaHwxfHx0cmF2ZWx8ZW58MHx8fHwxNjkzNTM1MzI1fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@neom?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`NEOM`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Discover your next adventure with Wanderlusts - Your personalized travel plan application for Wordpress. Optimize your journey from start to finish, tailored to your preferences.`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                <Card userTypeName="Travel Planner" type="travel-planner" abilities={appConfig.ownerAbilities} />
